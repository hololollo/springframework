...
public class TestController {
	...
	public String insTestPro(HttpServletRequest request, Model model) {
		int num = sampleService.maxNum() + 1; // 그 다음번호를 계산
		
		String title = request.getParameter("title"); // 폼에서 들어오 제목
		...
		return "redirect:testList.do"; // 페이지이동 : testList.do
	}
	...
	/*
	<li><a href="${path2 }/test/testList.do">테스트 목록</a>
	<li><a href="${path2 }/test/getTest.do?num=1">테스트1</a>
	<li><a href="${path2 }/test/modTest.do?num=1">테스트1 수정</a>
	<li><a href="${path2 }/test/insTest.do">테스트1 추가</a>
	<li><a href="${path2 }/test/delTest.do?num=1">테스트1 삭제</a>
	*/
