...
public class TestController2 {
	...
	// PathVariable => get방식에서만 사용. url경로를 만들어주기위해 EL({})방식을 사용한다.
	...
	//ModelAndView는 @Controller 어노테이션을 사용하기 전부터 사용되었고, Spring MVC가 @Controller 어노테이션을 지원하기 시작한 후로 ModelAndView를 잘 사용하지 않는다. 즉, 사장되었다.
	@GetMapping("get5.do")
